...
综合最优候选的 RMSE 为 3.47，MAE 为 2.89，模拟峰值为 110.36，模拟末日价格为 110.36。与阶段 3 初始筛选相比，本阶段给出了更完整的候选参数比较和分段误差解释。
...
|---|---:|---:|---:|---:|---:|---:|
| 综合最优 | 3.47 | -3.70 | 0.05 | 2.83 | 3.48 | 6.69 |
| RMSE最优 | 3.47 | -3.70 | 0.05 | 2.83 | 3.48 | 6.69 |
...
| 库存日缓冲上限 | 271 |
| 候选来源 | 局部稳健性复核 |
| pressure_scale | 0.029 |
| risk_weight | 2.429 |
| uncertainty_floor | 0.247 |
| inventory_response | 0.661 |
| adjustment_speed | 0.349 |
| buffer_relief_strength | 0.213 |
...
|---|---:|---:|---:|---:|---:|
| 全窗口 | 46 | 3.47 | 2.89 | 0.11 | 7.39 |
| 前期冲击_0到14天 | 11 | 3.16 | 2.76 | 0.05 | 6.10 |
| 中期平台_15到35天 | 14 | 4.42 | 3.75 | -0.89 | 7.39 |
| 后期再定价_36天以后 | 21 | 2.84 | 2.38 | 0.81 | 5.29 |
| 高价平台_actual大于等于110 | 4 | 2.83 | 2.32 | -2.29 | 3.94 |
| 低价回落_actual小于100 | 21 | 3.48 | 3.05 | 2.01 | 6.10 |
