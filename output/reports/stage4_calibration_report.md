...
综合最优候选的 RMSE 为 3.50，MAE 为 2.91，模拟峰值为 110.31，模拟末日价格为 110.31。与阶段 3 初始筛选相比，本阶段给出了更完整的候选参数比较和分段误差解释。
...
|---|---:|---:|---:|---:|---:|---:|
| 综合最优 | 3.50 | -3.75 | 0.00 | 2.74 | 3.51 | 6.73 |
| RMSE最优 | 3.50 | -3.75 | 0.00 | 2.74 | 3.51 | 6.73 |
...
| 库存日缓冲上限 | 282 |
| 候选来源 | 连续局部精修 |
| pressure_scale | 0.028 |
| risk_weight | 2.446 |
| uncertainty_floor | 0.244 |
| inventory_response | 0.664 |
| adjustment_speed | 0.342 |
| buffer_relief_strength | 0.216 |
| buffer_relief_decay_days | 12 |
...
|---|---:|---:|---:|---:|---:|
| 全窗口 | 46 | 3.50 | 2.91 | 0.13 | 7.21 |
| 前期冲击_0到14天 | 11 | 3.15 | 2.71 | -0.17 | 5.86 |
| 中期平台_15到35天 | 14 | 4.36 | 3.72 | -0.93 | 7.21 |
| 后期再定价_36天以后 | 21 | 2.99 | 2.47 | 1.00 | 5.35 |
| 高价平台_actual大于等于110 | 4 | 2.74 | 2.22 | -2.22 | 3.95 |
| 低价回落_actual小于100 | 21 | 3.51 | 3.08 | 1.92 | 5.86 |
