...
本题的核心不是简单外推油价曲线，而是解释封锁冲击如何经过供需缺口、政策缓冲、运输替代、库存消耗和风险预期传导到布伦特原油价格。题面给定的短期低弹性会放大无缓冲反事实价格，但附件真实价格只在约 110--120 美元/桶附近形成平台，说明市场中存在多重缓冲和再定价过程。因此，本文采用“反事实基准--短期递推--中长期情景--敏感性检验”的建模路线。
