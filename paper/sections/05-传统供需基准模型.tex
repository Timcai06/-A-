...
本文主口径采用线性需求曲线假设。设局部反需求函数为 \(P=a-bQ\)，并在战前均衡点 \(P_0,D_0\) 处使用题面给出的短期点弹性 \(\varepsilon\) 标定斜率。由点弹性定义

\begin{equation}
  \varepsilon
  =
  \frac{\mathrm d Q}{\mathrm d P}\frac{P_0}{D_0}
  =
  -\frac{1}{b}\frac{P_0}{D_0},
\end{equation}
