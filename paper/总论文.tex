...
针对任务二，本文构建 60--180 天乐观、中性、悲观三种情景路径。中性情景第 180 天价格约为 98.61 美元/桶，悲观情景第 180 天约为 114.49 美元/桶，且存在较高二次跳涨风险。敏感性分析表明，不确定性与制度风险强度、地缘风险权重和供应中断量是综合敏感度最高的三个因素；SPR 释放和绕道运输更主要影响外推期峰值、缺口闭合速度和削峰能力。
...
\begin{enumerate}
  ...
  \item 地缘风险、不确定性与制度风险、预期修复仍以参数化方式刻画，未引入期权隐含波动率、真实库存周报或新闻情绪等外生数据。
